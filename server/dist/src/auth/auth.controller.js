...
const authenticate_user_dto_1 = require("../users/dto/authenticate-user.dto");
...
let AuthController = class AuthController {
    ...
    async login(authenticateUserDto) {
...
__decorate([
    ...
    __param(0, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [authenticate_user_dto_1.AuthenticateUserDto]),
    __metadata("design:returntype", Promise)
